...
export const RECURSOS: Recurso[] = [
  {
    id: "ley-laura",
    tipo: "Comunicados",
    titulo: "Posición de LGB Colombia sobre la Ley Laura",
    resumen:
      "Apoyamos el propósito general de la Ley Laura porque la infancia necesita tiempo, acompañamiento y libertad, no intervenciones médicas irreversibles basadas en estereotipos de género.",
    etiquetas: [
      "Ley Laura",
      "Infancia",
    ...
    archivo: "/recursos/declaracion-ley-laura.pdf",
